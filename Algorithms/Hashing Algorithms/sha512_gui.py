...
class SHA512App:
    ...
    def generate_hash(self):
        ...
        sha512_hash = hashlib.sha512(plaintext.encode()).hexdigest()
        self.result_text.delete("1.0", tk.END)
        self.result_text.insert(tk.END, sha512_hash)
    ...
    def verify_hash(self):
        ...
        calculated_hash = hashlib.sha512(message.encode()).hexdigest()
